...
//	ofEnableSmoothing();
    ...
    gui1->loadSettings("ui/guiSettings1.xml");
    gui2->loadSettings("ui/guiSettings2.xml");
    gui3->loadSettings("ui/guiSettings3.xml");
...
void testApp::exit()
{
    gui1->saveSettings("ui/guiSettings1.xml");
    gui2->saveSettings("ui/guiSettings2.xml");
    gui3->saveSettings("ui/guiSettings3.xml");
	delete gui1;
	delete gui2;
    delete gui3;
	delete[] buffer;
...
void testApp::keyPressed(int key)
{
	...
	switch (key)
	{
		case '`':
		{
			...
			img.saveImage("/tmp/ofxui-snapshots/ "+ofToString(ofGetYear())+"-"+ofToString(ofGetMonth())+"-"+ofToString(ofGetDay())+" at "+ofToString(ofGetHours(),2)+"."+ofToString(ofGetMinutes(),2)+"."+ofToString(ofGetSeconds(),2) +hr +".png");
		}
			break;
...
void testApp::setGUI2()
{
    ...
    img = new ofImage();
    img->loadImage("images/nerd_me.png");
...
void testApp::setGUI3()
{
    ...
    gui3->addWidgetDown(new ofxUIImageButton(dim*4.0, dim*4.0, false, "images/App.png","IMAGEBTN"));
    gui3->addWidgetDown(new ofxUILabel("IMAGE TOGGLE", OFX_UI_FONT_MEDIUM));
    gui3->addWidgetDown(new ofxUIImageToggle(dim*4.0, dim*4.0, false, "images/Preview.png","IMAGETGL"));
