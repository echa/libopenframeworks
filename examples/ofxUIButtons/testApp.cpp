...
void testApp::setup()
{
    ...
    gui->addWidgetDown(new ofxUIImageButton(dim*2, dim*2, false, "images/pause.png", "IMAGE BUTTON"));
    gui->addWidgetRight(new ofxUIImageToggle(dim*2, dim*2, false, "images/play.png", "IMAGE TOGGLE"));
