...
void testApp::update() {
	...
	cout << " int year = " << info.getInt("year") << endl;
	cout << " int month = " << info.getInt("month") << endl;
	cout << " bool married = " << info.getBool("married") << endl;
	cout << " bool driver = " << info.getBool("driver") << endl;
	cout << " float age = " << info.getFloat("age") << endl;
	cout << " char initial = " << info.getChar("initial") << endl;
	cout << " string name = " << info.getString("name") << endl;
	cout << " ofPoint size = " << info.getPoint("size") << endl;
