...
void testApp::setup() {
	...
	loadImages("images/gif8", gif8);
	resaveImages<ofImage>("images/gif8");

	loadImages("images/png8", png8);
	resaveImages<ofImage>("images/png8");

	loadImages("images/jpg8", jpg8);
	resaveImages<ofImage>("images/jpg8");

	loadImages("images/png16", png16);
	resaveImages<ofShortImage>("images/png16");

	loadImages("images/exrFloat", exrFloat);
	resaveImages<ofFloatImage>("images/exrFloat");
	img8 = *exrFloat[0];
	img16 = *exrFloat[0];
	imgf = *exrFloat[0];
}
