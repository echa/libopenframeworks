...
void testApp::setup() {
	...
	pointLight.setDiffuseColor(ofFloatColor(0, 255, 0));
	pointLight.setSpecularColor(ofFloatColor(255, 255, 255));
	pointLight.setPointLight();
	
	spotLight.setDiffuseColor(ofFloatColor(255, 0, 0));
	spotLight.setSpecularColor(ofFloatColor(255, 255, 255));
	spotLight.setSpotlight(40, 6);
	
	directionalLight.setDiffuseColor(ofFloatColor(0, 0, 255));
	directionalLight.setSpecularColor(ofFloatColor(255, 255, 255));
